...
Version  : 3.3.121
Release  : 26
URL      : https://gtkwave.sourceforge.net/gtkwave-3.3.121.tar.gz
Source0  : https://gtkwave.sourceforge.net/gtkwave-3.3.121.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.121
cd %{_builddir}/gtkwave-3.3.121
pushd ..
cp -a gtkwave-3.3.121 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729885421
