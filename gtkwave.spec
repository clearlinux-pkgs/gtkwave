...
Source0  : https://gtkwave.sourceforge.net/gtkwave-3.3.123.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.123
cd %{_builddir}/gtkwave-3.3.123
pushd ..
cp -a gtkwave-3.3.123 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746455639
