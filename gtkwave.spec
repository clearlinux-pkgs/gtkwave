...
Version  : 3.3.120
Release  : 25
URL      : https://gtkwave.sourceforge.net/gtkwave-3.3.120.tar.gz
Source0  : https://gtkwave.sourceforge.net/gtkwave-3.3.120.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.120
cd %{_builddir}/gtkwave-3.3.120
pushd ..
cp -a gtkwave-3.3.120 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718745833
