...
Version  : 3.3.113
Release  : 17
URL      : https://gtkwave.sourceforge.net/gtkwave-3.3.113.tar.gz
Source0  : https://gtkwave.sourceforge.net/gtkwave-3.3.113.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.113
cd %{_builddir}/gtkwave-3.3.113
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664978975
