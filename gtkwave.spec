...
Version  : 3.3.109
Release  : 13
URL      : http://gtkwave.sourceforge.net/gtkwave-3.3.109.tar.gz
Source0  : http://gtkwave.sourceforge.net/gtkwave-3.3.109.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.109
cd %{_builddir}/gtkwave-3.3.109
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619996619
...
cp %{_builddir}/gtkwave-3.3.109/COPYING %{buildroot}/usr/share/package-licenses/gtkwave/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
cp %{_builddir}/gtkwave-3.3.109/src/libbz2/LICENSE %{buildroot}/usr/share/package-licenses/gtkwave/1c0c6888759a63c32bca7eb63353af2cd9bd5d9e
%make_install
