...
Source0  : https://gtkwave.sourceforge.net/gtkwave-3.3.122.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.122
cd %{_builddir}/gtkwave-3.3.122
pushd ..
cp -a gtkwave-3.3.122 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745331887
