...
Source0  : http://gtkwave.sourceforge.net/gtkwave-3.3.111.tar.gz
...
%prep
%setup -q -n gtkwave-3.3.111
cd %{_builddir}/gtkwave-3.3.111
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631038362
...
cp %{_builddir}/gtkwave-3.3.111/COPYING %{buildroot}/usr/share/package-licenses/gtkwave/13d2034b5ee3cb8d1a076370cf8f0e344a5d0855
cp %{_builddir}/gtkwave-3.3.111/LICENSE.TXT %{buildroot}/usr/share/package-licenses/gtkwave/13e470097596f182b8f9e00b1ec8d61473a9d4d1
cp %{_builddir}/gtkwave-3.3.111/src/libbz2/LICENSE %{buildroot}/usr/share/package-licenses/gtkwave/1c0c6888759a63c32bca7eb63353af2cd9bd5d9e
%make_install
...
/usr/share/package-licenses/gtkwave/13e470097596f182b8f9e00b1ec8d61473a9d4d1
